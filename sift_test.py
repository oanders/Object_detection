...
skridsko = cv2.imread('Images/skridsko/training/s3.jpg')
kub = cv2.imread('Images/skridsko/test/s5.jpg')
...
kpS, desS = sift.detectAndCompute(graySko,None)
kpK, desK = sift.detectAndCompute(grayKub,None)
